...
const RegistrationForm = ({userType}) => {
    ...
    const handleSubmission = async (e) => {
        ...
        if(user.name == "" || user.rollNumber == "" || user.dateOfBirth == "" || user.collegeMailId == "" || user.password == ""){
        ...
        if((dd>31 || dd<1) || (MM>12 || MM<1) || dateArray[2]?.length != 4 || dateArray.length != 3) {
        ...
        <form onSubmit={handleSubmission} className="mt-8">
            <div className="grid grid-cols-2 gap-4">
                <input 
                    type="text"
                    placeholder="Name"
                    className={clsx(`w-full px-2 py-4 border outline-0 ${userType=="teacher" && "col-span-full"}`)}
                ...
                />
                {
                    ...
                    <input 
                        ...
                        onChange={(e) => dispatch({ type: "rollNumber", payload: e.target.value })}
                ...
                <input 
                    ...
                    className="w-full px-2 py-4 border outline-0"
                    onChange={(e) => dispatch({ type: "dateOfBirth", payload: e.target.value })}
                ...
                <input 
                    ...
                    onChange={(e) => dispatch({ type: "collegeMailId", payload: e.target.value })}
                ...
                <div className="flex">
                    ...
                    />
                    <div className="flex items-center px-4 border-l-0 border text-2xl" onClick={() => setShowPasswordForConform(!showPasswordForConform)}>
            ...
            <div className="flex flex-col gap-4 mt-10">
                ...
                <Link href={"/login"} className="bg-blue-800 text-white w-full py-4 mt-4 text-center">
                    Login to Account
                </Link>
            </div>
        </form>
